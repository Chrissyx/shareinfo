...
begin
   ...
   0: begin //DEUTSCH / GERMAN / TYSK
         ...
         AboutBox.Caption := 'Über ShareInfo...';
         //--------------------------Messages--------------------------//
         //ShareInfo         
         ...
         LngNoHost := PChar('Host nicht erreichbar! Bitte Verbindung prüfen!');
   ...
   2: begin //NORWEGISCH / NORWEGIAN / NORSK
         ...
         ShareInfo.Label11.Caption := 'Størrelse:';
         ...
         LngNoNewVersion := PChar('Det er for øyeblikket ingen ny versjon tilgjengelig!');
         LngHint := PChar('Hint');
